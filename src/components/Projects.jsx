...
function Projects() {
  return (
        ...
        <div className="container px-5 py-10 mx-auto text-center lg:px-20">
          <div className="flex flex-col w-full mb-20">
            ...
            <p className="lg:w-2/3 mx-auto leading-relaxed text-base">
              Plock one one of the images bellow to see the repo or the deployed
              App!
            </p>
          </div>
          <div className="my-6 mx-1 grid grid-cols-1 gap-6 sm:grid-cols-1 md:grid-cols-2 ">
            {projects.map((project) => (
              ...
              //   className="sm:w-1/2 w-100 h-full p-4" rel="noreferrer">
              ...
              //       src={project.image}
              //     />
              //     <div className="px-8 py-10 relative z-10 w-full h-full border-4 border-purple-400 bg-gray-900 transition duration-300 ease-in-out opacity-0 hover:opacity-100">
    ...
    // {/* <div className="my-6 mx-6 grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
